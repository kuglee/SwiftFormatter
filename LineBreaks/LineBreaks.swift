...
public struct LineBreaksView: View {
  ...
  public init(store: Store<LineBreaksViewState, LineBreaksViewAction>) { self.store = store }
      ...
      VStack(alignment: .leading, spacing: .grid(2)) {
        ...
        Toggle(
          isOn: Binding(
            ...
            set: { self.store.send(.lineBreakBeforeControlFlowKeywordsFilledOut($0)) })
        ...
        Toggle(
          isOn: Binding(
            ...
            set: { self.store.send(.lineBreakBeforeEachGenericRequirementFilledOut($0)) })
        ...
        Toggle(
          isOn: Binding(
            ...
            set: {
              self.store.send(.lineBreakAroundMultilineExpressionChainComponentsFilledOut($0))
            })
        ...
        Toggle(
          isOn: Binding(
            ...
            set: { self.store.send(.prioritizeKeepingFunctionOutputTogetherFilledOut($0)) })
