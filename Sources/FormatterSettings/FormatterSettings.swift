...
public enum FormatterSettingsViewAction: Equatable {
...
extension FormatterSettingsViewState {
...
.combine(
  ...
  tabWidthViewReducer.pullback(
    state: \FormatterSettingsViewState.tabWidthView,
    action: /FormatterSettingsViewAction.tabWidthView,
    environment: {}
  ),
  lineLengthViewReducer.pullback(
    state: \FormatterSettingsViewState.lineLengthView,
    action: /FormatterSettingsViewAction.lineLengthView,
    environment: {}
  ),
  lineBreaksViewReducer.pullback(
    state: \FormatterSettingsViewState.lineBreaksView,
    action: /FormatterSettingsViewAction.lineBreaksView,
    environment: {}
  ),
  fileScopedDeclarationPrivacyViewReducer.pullback(
    state: \FormatterSettingsViewState.fileScopedDeclarationPrivacyView,
    action: /FormatterSettingsViewAction.fileScopedDeclarationPrivacyView,
    environment: {}
  )
)
